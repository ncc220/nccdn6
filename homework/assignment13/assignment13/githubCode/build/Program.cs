...
namespace build
{
    internal static class Program
    {
        ...
        internal static void Main(string[] args)
        {
            ...
            {
                Sign("./src/OidcClient/bin/Release", "IdentityModel.OidcClient.dll");
                Sign("./src/IdentityTokenValidator/bin/Release", "IdentityModel.OidcClient.IdentityTokenValidator.dll");
            });
